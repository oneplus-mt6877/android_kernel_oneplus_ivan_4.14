...
# Clang
		...
		git clone --depth=1 https://github.com/oneplus-mt6877/android_prebuilts_clang_host_linux-x86_clang-6443078.git "$HOME"/clang
...
# Gcc
	...
	export PATH=""$HOME"/clang/bin:$PATH:"$HOME"/gcc32/bin:$PATH:"$HOME"/gcc64/bin:$PATH"
